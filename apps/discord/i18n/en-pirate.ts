...
export default {
  ...
  common: {
    errors: {
      giveaway_state_unavailable: 'The treasure hunt state be unavailable, ye scurvy dog!'
    },
  ...
  commands: {
    ...
    start: {
      ...
      errors: {
        invalid_duration_format: 'Arrr! Invalid time format, ye landlubber! Use: 30s, 5m, 2h, 1d',
        duration_too_long: "This treasure hunt can't sail longer than 14 days, ye scallywag!",
        duration_too_short: "This treasure hunt can't be shorter than 10 seconds, matey!",
        failed_to_create_message: 'Failed to launch the treasure hunt message, arrr!',
        failed_to_start: 'Failed to start the treasure hunt: {error}, ye bilge rat!'
      }
    },
    stop: {
      name: 'stop',
    ...
    reroll: {
      ...
      errors: {
        ...
        no_winners_available: 'No new pirates could be picked, as there be no other crew members aboard!'
      },
      messages: {
        partial_success_singular: '🎉 A new lucky pirate has been chosen!\nCongratulations to {winners}, ye scallywag!',
        partial_success_plural:
          '🎉 {count} new lucky pirates have been chosen!\nCongratulations to {winners}, ye scallywags!',
        success_singular: '🎉 New lucky pirate has been chosen!\nCongratulations to {winners}, arrr!',
        success_plural: '🎉 New lucky pirates have been chosen!\nCongratulations to {winners}, ye hearties!'
      }
    },
    savetest: {
      name: 'savetest',
