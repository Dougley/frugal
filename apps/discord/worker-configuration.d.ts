/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7db112770920bab645ac3afd3e4d1db3)
// Runtime types generated with workerd@1.20251217.0 2025-11-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GiveawayStateV3";
	}
	interface Env {
		KV: KVNamespace;
		...
		PREMIUM_SKU_ID: string;
		GIVEAWAY_STATE: DurableObjectNamespace<import("./src/index").GiveawayStateV3>;
		STORAGE: R2Bucket;
		D1: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_DSN" | "DISCORD_APP_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_BOT_TOKEN" | "DEVELOPMENT_GUILD" | "PREMIUM_SKU_ID">> {}
}
declare module "*.sql" {
	const value: string;
